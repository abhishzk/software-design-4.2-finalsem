...
public class TeacherPanel extends BasicPanel {
	...
	private final JLabel personalIdLabel = new JLabel("Phone Number:");
	private final JLabel genderLabel = new JLabel("Gender:");
	private final JLabel cityLabel = new JLabel("Department");
	...
	private final JComboBox<Department> cityComboBox = 
			new JComboBox<Department>(new Department[] {Department.NotSelected, Department.Engineering, Department.Business, Department.Pharmaceutical, Department.Nursing,Department.Art,Department.Commerce,Department.Other});
	...
	public List<Teacher> getTeachers() {
		...
		try {
			Teacher newTeacher = new Teacher(
					...
					(Department) this.cityComboBox.getSelectedItem());
	...
	public void clearFields() {
		...
		this.cityComboBox.setSelectedItem(Department.NotSelected);
	}
